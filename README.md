 ...
 * 从题库[仓库](https://github.com/chyyuu/os_course_exercise_library)中把原始md文件clone下来，利用[produce_exercise.py](https://github.com/chyyuu/os_course_exercise_library/blob/master/tools/produce_exercise.py)对文件进行预处理，然后用gitbook的build命令把md文件处理成html，再提交到html[仓库](https://github.com/chtq/exercise_web)。
